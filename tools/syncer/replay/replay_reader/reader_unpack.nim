...
proc unpack*(line: string): ReplayPayloadRef =
  ...
  of TrtFetchHeaders:
    return ReplayFetchHeaders.init(
      data, TrtFetchHeaders, TraceFetchHeaders)

  of TrtSyncHeaders:
    return ReplaySyncHeaders.init(
      data, TrtSyncHeaders, TraceSyncHeaders)


  of TrtFetchBodies:
    return ReplayFetchBodies.init(
      data, TrtFetchBodies, TraceFetchBodies)

  of TrtSyncBodies:
    return ReplaySyncBodies.init(
      data, TrtSyncBodies, TraceSyncBodies)
  ...
  of TrtSyncBlock:
    return ReplaySyncBlock.init(
      data, TrtSyncBlock, TraceSyncBlock)
