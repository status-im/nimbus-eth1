...
import std/[os, osproc, strutils, json, tables], unittest2, "."/[types]
...
proc t8nInput(alloc, txs, env, fork, reward: string): T8nInput =
  T8nInput(inAlloc: alloc, inTxs: txs, inEnv: env, stFork: fork, stReward: reward)
...
proc notRejectedError(path: string): bool =
  ...
  # message
  not (path.startsWith("root/result/rejected/") and path.endsWith("/error"))
  ...
  if spec.expOut.len > 0:
    if spec.expOut.endsWith(".json"):
      ...
      if not jsc.cmp(want, have, "root") and notRejectedError(jsc.path):
        ...
        echo "path: $1, error: $2" % [jsc.path, jsc.error]
        return false
    else:
...
const testSpec = [
  TestSpec(
    ...
    base: "testdata/1",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Frontier+1346", ""),
  ...
  TestSpec(
    name: "baseline test",
    base: "testdata/1",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Byzantium", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    name: "blockhash test",
    base: "testdata/3",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Berlin", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
  ...
  TestSpec(
    name: "Uncle test",
    base: "testdata/5",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Byzantium", "0x80"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    base: "testdata/13",
    input: t8nInput("alloc.json", "txs.json", "env.json", "London", ""),
  ...
  TestSpec(
    ...
    base: "testdata/13",
    input: t8nInput("alloc.json", "signed_txs.rlp", "env.json", "London", ""),
  ...
  TestSpec(
    ...
    base: "testdata/14",
    input: t8nInput("alloc.json", "txs.json", "env.uncles.json", "London", ""),
    output: T8nOutput(result: true),
    expOut: "exp2.json",
  ),
  TestSpec(
    ...
    base: "testdata/14",
    input: t8nInput("alloc.json", "txs.json", "env.uncles.json", "Berlin", ""),
    output: T8nOutput(result: true),
  ...
  TestSpec(
    ...
    base: "testdata/19",
    input: t8nInput("alloc.json", "txs.json", "env.json", "ArrowGlacier", ""),
    output: T8nOutput(result: true),
  ...
  TestSpec(
    ...
    base: "testdata/19",
    input: t8nInput("alloc.json", "txs.json", "env.json", "GrayGlacier", ""),
    output: T8nOutput(result: true),
  ...
  TestSpec(
    ...
    base: "testdata/24",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Merge", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    base: "testdata/24",
    input: t8nInput("alloc.json", "txs.json", "env-missingrandom.json", "Merge", ""),
  ...
  TestSpec(
    ...
    base: "testdata/3",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Berlin", "-1"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.rlp", "env.json", "EIP150", "-1"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.rlp", "env.json", "EIP150", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    base: "testdata/00-502",
    input: t8nInput("alloc.json", "txs.json", "env.json", "EIP150", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.json", "env.json", "London", "-1"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
  ...
  TestSpec(
    ...
    input:
      t8nInput("alloc.json", "txs.json", "env.json", "Berlin", "2000000000000000000"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
  ...
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.rlp", "env.json", "Byzantium", "-1"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    base: "testdata/26",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Shanghai", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.rlp", "env.json", "Berlin", "0"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
  ...
  TestSpec(
    ...
    input:
      t8nInput("alloc.json", "txs.rlp", "env.json", "Frontier", "5000000000000000000"),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.json", "env.json", "Cancun", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
  ...
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.json", "env.json", "Shanghai", "0"),
  ...
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.json", "env.json", "Merge", "0"),
  ...
  TestSpec(
    name: "Cancun tests",
    base: "testdata/28",
    input: t8nInput("alloc.json", "txs.rlp", "env.json", "Cancun", ""),
    output: T8nOutput(alloc: true, result: true),
    expOut: "exp.json",
  ),
  TestSpec(
  ...
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.json", "env.json", "Berlin", "0"),
    output: T8nOutput(trace: true, result: true),
    expOut: "exp.txt",
  ),
  TestSpec(
    ...
    base: "testdata/00-522",
    input: t8nInput("alloc.json", "txs.json", "env.json", "London", "0"),
    output: T8nOutput(trace: true, result: true),
    expOut: "exp.txt",
  ),
  TestSpec(
    ...
    base: "testdata/00-522",
    input: t8nInput("alloc.json", "txs.json", "env.json", "Istanbul", "0"),
    output: T8nOutput(trace: true, result: true),
    expOut: "istanbul.txt",
  ),
  TestSpec(
    ...
    input: t8nInput("alloc.json", "txs.rlp", "env.json", "Cancun", "0"),
    output: T8nOutput(result: true),
    expOut: "exp.json",
  ),
  TestSpec(
