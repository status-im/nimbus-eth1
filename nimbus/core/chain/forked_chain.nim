...
func canonicalChain(c: ForkedChainRef,
                    hash: Hash32,
                    headHash: Hash32): Result[BlockHeader, string] =
  if hash == c.baseHash:
...
proc headerByHash*(c: ForkedChainRef, blockHash: Hash32): Result[BlockHeader, string] =
...
proc blockByHash*(c: ForkedChainRef, blockHash: Hash32): Opt[EthBlock] =
