...
proc getAccounts*(ctx: CoreDbCtxRef): CoreDbAccRef =
  ...
  result = ctx.methods.getAccountsFn()
...
proc fetch*(acc: CoreDbAccRef; eAddr: EthAddress): CoreDbRc[CoreDbAccount] =
  ...
  result = acc.methods.fetchFn eAddr
...
proc delete*(acc: CoreDbAccRef; eAddr: EthAddress): CoreDbRc[void] =
  ...
  result = acc.methods.deleteFn eAddr
  acc.ifTrackNewApi: debug newApiTxt, api, elapsed, eAddr, result
...
proc clearStorage*(acc: CoreDbAccRef; eAddr: EthAddress): CoreDbRc[void] =
  ...
  result = acc.methods.clearStorageFn eAddr
  acc.ifTrackNewApi: debug newApiTxt, api, elapsed, eAddr, result
...
proc hasPath*(acc: CoreDbAccRef; eAddr: EthAddress): CoreDbRc[bool] =
  ...
  result = acc.methods.hasPathFn eAddr
  acc.ifTrackNewApi: debug newApiTxt, api, elapsed, eAddr, result
...
proc slotFetch*(
  ...
  result = acc.methods.slotFetchFn(eAddr, slot)
  acc.ifTrackNewApi: debug newApiTxt, api, elapsed, eAddr, result
...
proc slotDelete*(
  ...
  result = acc.methods.slotDeleteFn(eAddr, slot)
  acc.ifTrackNewApi: debug newApiTxt, api, elapsed, eAddr, result
...
proc slotHasPath*(
  ...
  result = acc.methods.slotHasPathFn(eAddr, slot)
  acc.ifTrackNewApi: debug newApiTxt, api, elapsed, eAddr, result
...
proc slotMerge*(
  ...
  result = acc.methods.slotMergeFn(eAddr, slot, data)
  acc.ifTrackNewApi: debug newApiTxt, api, elapsed, eAddr, result
...
proc slotState*(
  ...
  result = acc.methods.slotStateFn(eAddr, updateOk)
