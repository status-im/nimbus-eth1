...
proc validate*(ldg: LedgerRef) =
  ...
  doAssert not ldg.iterators.accountsIt.isNil
  doAssert not ldg.iterators.addressesIt.isNil
  doAssert not ldg.iterators.cachedStorageIt.isNil
  doAssert not ldg.iterators.pairsIt.isNil
  doAssert not ldg.iterators.storageIt.isNil
