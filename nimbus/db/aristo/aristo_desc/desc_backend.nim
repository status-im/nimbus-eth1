...
import results, "."/[desc_error, desc_identifiers, desc_structural]
...
type
  ...
  GetTuvFn* = proc(): Result[VertexID, AristoError] {.gcsafe, raises: [].}
    ## Generic backend database retrieval function for the top used
    ## vertex ID.

  GetLstFn* = proc(): Result[SavedState, AristoError] {.gcsafe, raises: [].}
  ...
  BackendObj* = object of RootObj ## Backend interface.
