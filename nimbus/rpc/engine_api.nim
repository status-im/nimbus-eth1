...
const supportedMethods: HashSet[string] = toHashSet(
  [
    "engine_newPayloadV1", "engine_newPayloadV2", "engine_newPayloadV3",
    "engine_newPayloadV4", "engine_getPayloadV1", "engine_getPayloadV2",
...
proc setupEngineAPI*(engine: BeaconEngineRef, server: RpcServer) =
  ...
  server.rpc("engine_getClientVersionV1") do(
