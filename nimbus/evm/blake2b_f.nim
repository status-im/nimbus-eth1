...
proc blake2Transform(
    ctx: var Blake2bContext, input: openArray[byte], last: bool, rounds: uint32
) {.inline.} =
  ...
  m[0] = leLoad64(input, 0)
  m[1] = leLoad64(input, 8)
  m[2] = leLoad64(input, 16)
  m[3] = leLoad64(input, 24)
  m[4] = leLoad64(input, 32)
  m[5] = leLoad64(input, 40)
  m[6] = leLoad64(input, 48)
  m[7] = leLoad64(input, 56)
  m[8] = leLoad64(input, 64)
  m[9] = leLoad64(input, 72)
  m[10] = leLoad64(input, 80)
  m[11] = leLoad64(input, 88)
  m[12] = leLoad64(input, 96)
  m[13] = leLoad64(input, 104)
  m[14] = leLoad64(input, 112)
  m[15] = leLoad64(input, 120)
