...
export p2p_node.NodeId, p2p_node.Node, p2p_node.newNode, enode.ENode, enr.Record
...
func getEnr*(proto: Eth1Discovery): Opt[enr.Record] =
  ...
  Opt.some(proto.discv5.getRecord())
