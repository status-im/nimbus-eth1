...
proc initInstance*(
  ...
  db.accLeaves = LruCache[Hash32, Opt[(AristoAccount, StorageID, NibblesBuf)]].init(ACC_LRU_SIZE)
  db.stoLeaves = LruCache[Hash32, Opt[(UInt256, NibblesBuf)]].init(ACC_LRU_SIZE)
