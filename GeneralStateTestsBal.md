GeneralStateTestsBal
===
## coverage
```diff
+ test_coverage.json                                              OK
```
OK: 1/1 Fail: 0/1 Skip: 0/1
## create
```diff
+ test_create_deposit_oog.json                                    OK
+ test_create_one_byte.json                                       OK
+ test_create_suicide_during_transaction_create.json              OK
+ test_create_suicide_store.json                                  OK
```
OK: 4/4 Fail: 0/4 Skip: 0/4
## eip1014_create2
```diff
+ test_create2_return_data.json                                   OK
```
OK: 1/1 Fail: 0/1 Skip: 0/1
## eip1153_tstore
```diff
+ test_basic_tload_after_store.json                               OK
+ test_basic_tload_gasprice.json                                  OK
+ test_basic_tload_other_after_tstore.json                        OK
+ test_basic_tload_transaction_begin.json                         OK
+ test_basic_tload_works.json                                     OK
+ test_contract_creation.json                                     OK
+ test_gas_usage.json                                             OK
+ test_reentrant_call.json                                        OK
+ test_reentrant_selfdestructing_call.json                        OK
+ test_run_until_out_of_gas.json                                  OK
+ test_subcall.json                                               OK
+ test_tload_after_sstore.json                                    OK
+ test_tload_after_tstore.json                                    OK
+ test_tload_after_tstore_is_zero.json                            OK
+ test_tload_calls.json                                           OK
+ test_tload_reentrancy.json                                      OK
+ test_transient_storage_unset_values.json                        OK
+ test_tstore_reentrancy.json                                     OK
```
OK: 18/18 Fail: 0/18 Skip: 0/18
## eip1344_chainid
```diff
+ test_chainid.json                                               OK
```
OK: 1/1 Fail: 0/1 Skip: 0/1
## eip145_bitwise_shift
```diff
+ test_combinations.json                                          OK
```
OK: 1/1 Fail: 0/1 Skip: 0/1
## eip152_blake2
```diff
+ test_blake2_precompile_delegatecall.json                        OK
+ test_blake2b.json                                               OK
+ test_blake2b_gas_limit.json                                     OK
+ test_blake2b_invalid_gas.json                                   OK
+ test_blake2b_large_gas_limit.json                               OK
```
OK: 5/5 Fail: 0/5 Skip: 0/5
## eip1559_fee_market_change
```diff
+ test_eip1559_tx_validity.json                                   OK
```
OK: 1/1 Fail: 0/1 Skip: 0/1
## eip196_ec_add_mul
```diff
+ test_gas_costs.json                                             OK
+ test_invalid.json                                               OK
+ test_valid.json                                                 OK
```
...
## eip214_staticcall
```diff
+ test_staticcall_call_to_precompile.json                         OK
+ test_staticcall_call_to_precompile_from_contract_init.json      OK
+ test_staticcall_nested_call_to_precompile.json                  OK
+ test_staticcall_reentrant_call_to_precompile.json               OK
```
OK: 4/4 Fail: 0/4 Skip: 0/4
## eip2537_bls_12_381_precompiles
```diff
+ test_call_types.json                                            OK
+ test_gas.json                                                   OK
+ test_invalid.json                                               OK
+ test_invalid_gas_g1msm.json                                     OK
+ test_invalid_gas_g2msm.json                                     OK
+ test_invalid_gas_pairing.json                                   OK
+ test_invalid_length_g1msm.json                                  OK
+ test_invalid_length_g2msm.json                                  OK
+ test_invalid_length_pairing.json                                OK
+ test_invalid_multi_inf.json                                     OK
+ test_invalid_zero_gas_g1msm.json                                OK
+ test_invalid_zero_gas_g2msm.json                                OK
+ test_invalid_zero_gas_pairing.json                              OK
+ test_invalid_zero_length_g1msm.json                             OK
+ test_invalid_zero_length_g2msm.json                             OK
+ test_invalid_zero_length_pairing.json                           OK
+ test_isogeny_kernel_values.json                                 OK
+ test_valid.json                                                 OK
+ test_valid_gas_g1msm.json                                       OK
+ test_valid_gas_g2msm.json                                       OK
+ test_valid_gas_pairing.json                                     OK
+ test_valid_multi_inf.json                                       OK
```
OK: 22/22 Fail: 0/22 Skip: 0/22
## eip2929_gas_cost_increases
```diff
+ test_call_insufficient_balance.json                             OK
```
OK: 1/1 Fail: 0/1 Skip: 0/1
## eip2930_access_list
```diff
+ test_account_storage_warm_cold_state.json                       OK
+ test_eip2930_tx_validity.json                                   OK
+ test_repeated_address_acl.json                                  OK
+ test_transaction_intrinsic_gas_cost.json                        OK
+ test_tx_intrinsic_gas.json                                      OK
```
OK: 5/5 Fail: 0/5 Skip: 0/5
## eip3651_warm_coinbase
```diff
+ test_warm_coinbase_call_out_of_gas.json                         OK
+ test_warm_coinbase_gas_usage.json                               OK
```
OK: 2/2 Fail: 0/2 Skip: 0/2
## eip3855_push0
```diff
+ test_push0_contract_during_call_contexts.json                   OK
+ test_push0_contracts.json                                       OK
```
OK: 2/2 Fail: 0/2 Skip: 0/2
## eip3860_initcode
```diff
+ test_contract_creating_tx.json                                  OK
+ test_create_opcode_initcode.json                                OK
+ test_gas_usage.json                                             OK
```
OK: 3/3 Fail: 0/3 Skip: 0/3
## eip4844_blobs
```diff
+ test_blob_gas_subtraction_tx.json                               OK
+ test_blob_tx_attribute_calldata_opcodes.json                    OK
+ test_blob_tx_attribute_gasprice_opcode.json                     OK
+ test_blob_tx_attribute_opcodes.json                             OK
+ test_blob_tx_attribute_value_opcode.json                        OK
+ test_blobhash_gas_cost.json                                     OK
+ test_blobhash_opcode_contexts.json                              OK
+ test_blobhash_opcode_contexts_tx_types.json                     OK
+ test_call_opcode_types.json                                     OK
+ test_external_vectors.json                                      OK
+ test_insufficient_balance_blob_tx.json                          OK
+ test_invalid_blob_hash_versioning_single_tx.json                OK
+ test_invalid_inputs.json                                        OK
+ test_invalid_normal_gas.json                                    OK
+ test_invalid_tx_blob_count.json                                 OK
+ test_invalid_tx_max_fee_per_blob_gas_state.json                 OK
+ test_point_evaluation_precompile_gas_usage.json                 OK
+ test_sufficient_balance_blob_tx.json                            OK
+ test_tx_entry_point.json                                        OK
+ test_valid_inputs.json                                          OK
```
OK: 20/20 Fail: 0/20 Skip: 0/20
## eip5656_mcopy
```diff
+ test_mcopy_huge_memory_expansion.json                           OK
+ test_mcopy_memory_expansion.json                                OK
+ test_mcopy_on_empty_memory.json                                 OK
+ test_no_memory_corruption_on_upper_call_stack_levels.json       OK
+ test_no_memory_corruption_on_upper_create_stack_levels.json     OK
+ test_valid_mcopy_operations.json                                OK
```
OK: 6/6 Fail: 0/6 Skip: 0/6
## eip6780_selfdestruct
```diff
+ test_calling_from_new_contract_to_pre_existing_contract.json    OK
+ test_calling_from_pre_existing_contract_to_new_contract.json    OK
+ test_create_selfdestruct_same_tx.json                           OK
+ test_create_selfdestruct_same_tx_increased_nonce.json           OK
+ test_dynamic_create2_selfdestruct_collision.json                OK
+ test_reentrancy_selfdestruct_revert.json                        OK
+ test_self_destructing_initcode.json                             OK
+ test_self_destructing_initcode_create_tx.json                   OK
+ test_selfdestruct_created_in_same_tx_with_revert.json           OK
+ test_selfdestruct_not_created_in_same_tx_with_revert.json       OK
+ test_selfdestruct_pre_existing.json                             OK
```
OK: 11/11 Fail: 0/11 Skip: 0/11
## eip7516_blobgasfee
```diff
+ test_blobbasefee_out_of_gas.json                                OK
+ test_blobbasefee_stack_overflow.json                            OK
```
OK: 2/2 Fail: 0/2 Skip: 0/2
## eip7594_peerdas
```diff
+ test_invalid_max_blobs_per_tx.json                              OK
+ test_valid_max_blobs_per_tx.json                                OK
```
OK: 2/2 Fail: 0/2 Skip: 0/2
## eip7610_create_collision
```diff
+ test_collision_with_create2_revert_in_initcode.json             OK
+ test_create2_collision_storage.json                             OK
+ test_init_collision_create_opcode.json                          OK
+ test_init_collision_create_tx.json                              OK
```
OK: 4/4 Fail: 0/4 Skip: 0/4
## eip7623_increase_calldata_cost
```diff
+ test_full_gas_consumption.json                                  OK
+ test_gas_consumption_below_data_floor.json                      OK
+ test_gas_refunds_from_data_floor.json                           OK
+ test_transaction_validity_type_0.json                           OK
+ test_transaction_validity_type_1_type_2.json                    OK
+ test_transaction_validity_type_3.json                           OK
+ test_transaction_validity_type_4.json                           OK
```
OK: 7/7 Fail: 0/7 Skip: 0/7
## eip7702_set_code_tx
```diff
+ test_account_warming.json                                       OK
+ test_address_from_set_code.json                                 OK
+ test_call_into_chain_delegating_set_code.json                   OK
+ test_call_into_self_delegating_set_code.json                    OK
+ test_call_pointer_to_created_from_create_after_oog_call_again.j OK
+ test_call_to_pre_authorized_oog.json                            OK
+ test_call_to_precompile_in_pointer_context.json                 OK
+ test_contract_create.json                                       OK
+ test_contract_storage_to_pointer_with_storage.json              OK
+ test_creating_delegation_designation_contract.json              OK
+ test_creating_tx_to_contract_creator.json                       OK
+ test_delegate_call_targets.json                                 OK
+ test_delegated_eoa_can_send_creating_tx.json                    OK
+ test_delegation_clearing.json                                   OK
+ test_delegation_clearing_and_set.json                           OK
+ test_delegation_clearing_failing_tx.json                        OK
+ test_delegation_clearing_tx_to.json                             OK
+ test_delegation_replacement_call_previous_contract.json         OK
+ test_deploying_delegation_designation_contract.json             OK
+ test_double_auth.json                                           OK
+ test_empty_authorization_list.json                              OK
+ test_eoa_init_as_pointer.json                                   OK
+ test_ext_code_on_chain_delegating_set_code.json                 OK
+ test_ext_code_on_self_delegating_set_code.json                  OK
+ test_ext_code_on_self_set_code.json                             OK
+ test_ext_code_on_set_code.json                                  OK
+ test_gas_cost.json                                              OK
+ test_intrinsic_gas_cost.json                                    OK
+ test_many_delegations.json                                      OK
+ test_nonce_overflow_after_first_authorization.json              OK
+ test_nonce_validity.json                                        OK
+ test_pointer_call_followed_by_direct_call.json                  OK
+ test_pointer_contract_pointer_loop.json                         OK
+ test_pointer_reentry.json                                       OK
+ test_pointer_reverts.json                                       OK
+ test_pointer_to_pointer.json                                    OK
+ test_pointer_to_precompile.json                                 OK
+ test_pointer_to_static.json                                     OK
+ test_pointer_to_static_reentry.json                             OK
+ test_self_code_on_set_code.json                                 OK
+ test_self_set_code_cost.json                                    OK
+ test_self_sponsored_set_code.json                               OK
+ test_set_code_address_and_authority_warm_state.json             OK
+ test_set_code_address_and_authority_warm_state_call_types.json  OK
+ test_set_code_all_invalid_authorization_tuples.json             OK
+ test_set_code_call_set_code.json                                OK
+ test_set_code_from_account_with_non_delegating_code.json        OK
+ test_set_code_max_depth_call_stack.json                         OK
+ test_set_code_multiple_first_valid_authorization_tuples_same_si OK
+ test_set_code_multiple_valid_authorization_tuples_first_invalid OK
+ test_set_code_multiple_valid_authorization_tuples_same_signer_i OK
+ test_set_code_multiple_valid_authorization_tuples_same_signer_i OK
+ test_set_code_to_account_deployed_in_same_tx.json               OK
+ test_set_code_to_contract_creator.json                          OK
+ test_set_code_to_log.json                                       OK
+ test_set_code_to_non_empty_storage_non_zero_nonce.json          OK
+ test_set_code_to_precompile.json                                OK
+ test_set_code_to_precompile_not_enough_gas_for_precompile_execu OK
+ test_set_code_to_self_caller.json                               OK
+ test_set_code_to_self_destruct.json                             OK
+ test_set_code_to_self_destructing_account_deployed_in_same_tx.j OK
+ test_set_code_to_sstore.json                                    OK
+ test_set_code_to_tstore_available_at_correct_address.json       OK
+ test_set_code_to_tstore_reentry.json                            OK
+ test_set_code_transaction_fee_validations.json                  OK
+ test_set_code_using_chain_specific_id.json                      OK
+ test_set_code_using_valid_synthetic_signatures.json             OK
+ test_signature_s_out_of_range.json                              OK
+ test_static_to_pointer.json                                     OK
+ test_tx_into_chain_delegating_set_code.json                     OK
+ test_tx_into_self_delegating_set_code.json                      OK
+ test_valid_tx_invalid_auth_signature.json                       OK
+ test_valid_tx_invalid_chain_id.json                             OK
```
OK: 73/73 Fail: 0/73 Skip: 0/73
## eip7708_eth_transfer_logs
```diff
+ test_call_opcodes_transfer_log_behavior.json                    OK
+ test_call_to_delegated_account_with_value.json                  OK
+ test_call_to_self_no_log.json                                   OK
+ test_call_with_value_mainnet.json                               OK
+ test_contract_creation_tx.json                                  OK
+ test_contract_log_and_transfer_ordering.json                    OK
+ test_create_collision_no_log.json                               OK
+ test_create_initcode_stop_emits_log.json                        OK
+ test_create_insufficient_balance_no_log.json                    OK
+ test_create_opcode_emits_log.json                               OK
+ test_create_out_of_gas_no_log.json                              OK
+ test_delegatecall_inner_call_with_value.json                    OK
+ test_failed_create_with_value_no_log.json                       OK
+ test_failed_inner_operation_no_log.json                         OK
+ test_finalization_selfdestruct_logs.json                        OK
+ test_initcode_calls_with_value.json                             OK
+ test_inner_call_succeeds_outer_reverts_no_log.json              OK
+ test_nested_calls_log_order.json                                OK
+ test_reverted_transaction_no_log.json                           OK
+ test_selfdestruct_during_initcode.json                          OK
+ test_selfdestruct_mainnet.json                                  OK
+ test_selfdestruct_same_tx_via_call.json                         OK
+ test_selfdestruct_to_different_address_same_tx.json             OK
+ test_selfdestruct_to_self_pre_existing_no_log.json              OK
+ test_selfdestruct_to_self_same_tx.json                          OK
+ test_selfdestruct_to_system_address.json                        OK
+ test_selfdestruct_with_value_emits_log.json                     OK
+ test_simple_transfer_emits_log.json                             OK
+ test_simple_transfer_mainnet.json                               OK
+ test_stack_underflow_no_log.json                                OK
+ test_transfer_to_delegated_account_emits_log.json               OK
+ test_transfer_to_self_no_log.json                               OK
+ test_transfer_to_special_address.json                           OK
+ test_transfer_with_all_tx_types.json                            OK
+ test_zero_value_operations_no_log.json                          OK
+ test_zero_value_transfer_no_log.json                            OK
```
OK: 36/36 Fail: 0/36 Skip: 0/36
## eip7823_modexp_upper_bounds
```diff
+ test_modexp_upper_bounds.json                                   OK
```
OK: 1/1 Fail: 0/1 Skip: 0/1
## eip7825_transaction_gas_limit_cap
```diff
+ test_maximum_gas_refund.json                                    OK
+ test_transaction_gas_limit_cap.json                             OK
+ test_tx_gas_limit_cap_access_list_with_diff_addr.json           OK
+ test_tx_gas_limit_cap_access_list_with_diff_keys.json           OK
+ test_tx_gas_limit_cap_authorized_tx.json                        OK
+ test_tx_gas_limit_cap_contract_creation.json                    OK
+ test_tx_gas_limit_cap_full_calldata.json                        OK
+ test_tx_gas_limit_cap_subcall_context.json                      OK
```
OK: 8/8 Fail: 0/8 Skip: 0/8
## eip7843_slotnum
```diff
+ test_slotnum_gas_cost.json                                      OK
+ test_slotnum_value.json                                         OK
```
OK: 2/2 Fail: 0/2 Skip: 0/2
## eip7883_modexp_gas_increase
```diff
+ test_contract_creation_transaction.json                         OK
+ test_contract_initcode.json                                     OK
+ test_modexp_boundary_inputs.json                                OK
+ test_modexp_call_operations.json                                OK
+ test_modexp_gas_usage_contract_wrapper.json                     OK
+ test_modexp_invalid_inputs.json                                 OK
+ test_modexp_used_in_transaction_entry_points.json               OK
+ test_modexp_variable_gas_cost.json                              OK
+ test_modexp_variable_gas_cost_exceed_tx_gas_cap.json            OK
+ test_vectors_from_eip.json                                      OK
+ test_vectors_from_legacy_tests.json                             OK
```
OK: 11/11 Fail: 0/11 Skip: 0/11
## eip7939_count_leading_zeros
```diff
+ test_clz_call_operation.json                                    OK
+ test_clz_code_copy_operation.json                               OK
+ test_clz_from_set_code.json                                     OK
+ test_clz_gas_cost.json                                          OK
+ test_clz_gas_cost_boundary.json                                 OK
+ test_clz_initcode_context.json                                  OK
+ test_clz_initcode_create.json                                   OK
+ test_clz_jump_operation.json                                    OK
+ test_clz_opcode_scenarios.json                                  OK
+ test_clz_push_operation_same_value.json                         OK
+ test_clz_stack_not_overflow.json                                OK
+ test_clz_stack_underflow.json                                   OK
+ test_clz_with_memory_operation.json                             OK
```
...
+ test_gas.json                                                   OK
+ test_invalid.json                                               OK
+ test_modular_comparison.json                                    OK
+ test_precompile_as_tx_entry_point.json                          OK
+ test_precompile_will_return_success_with_tx_value.json          OK
+ test_valid.json                                                 OK
+ test_wycheproof_extra.json                                      OK
+ test_wycheproof_invalid.json                                    OK
+ test_wycheproof_valid.json                                      OK
```
OK: 12/12 Fail: 0/12 Skip: 0/12
## eip8024_dupn_swapn_exchange
```diff
+ test_dupn_basic.json                                            OK
+ test_dupn_invalid_immediate_aborts.json                         OK
+ test_dupn_jump_to_immediate_byte_0x5b_succeeds.json             OK
+ test_dupn_jump_to_valid_immediate_fails.json                    OK
+ test_dupn_multiple_consecutive_pc_advancement.json              OK
+ test_dupn_pc_advances_by_2.json                                 OK
+ test_dupn_stack_underflow.json                                  OK
+ test_dupn_valid_immediates.json                                 OK
+ test_dupn_with_dup1_sequence.json                               OK
+ test_eip_vector_dupn_duplicate_bottom.json                      OK
+ test_eip_vector_dupn_stack_underflow.json                       OK
+ test_eip_vector_end_of_code.json                                OK
+ test_eip_vector_exchange_swap_positions.json                    OK
+ test_eip_vector_exchange_with_iszero.json                       OK
+ test_eip_vector_jump_over_invalid_dupn.json                     OK
+ test_eip_vector_swapn_invalid_immediate_reverts.json            OK
+ test_eip_vector_swapn_swap_with_bottom.json                     OK
+ test_endofcode_behavior.json                                    OK
+ test_exchange_basic.json                                        OK
+ test_exchange_invalid_immediate_aborts.json                     OK
+ test_exchange_jump_to_immediate_byte.json                       OK
+ test_exchange_pc_advances_by_2.json                             OK
+ test_exchange_preserves_other_items.json                        OK
+ test_exchange_stack_underflow.json                              OK
+ test_exchange_valid_immediates.json                             OK
+ test_exchange_with_push_sequence.json                           OK
+ test_mixed_opcodes_pc_advancement.json                          OK
+ test_swapn_basic.json                                           OK
+ test_swapn_jump_to_immediate_byte_0x5b_succeeds.json            OK
+ test_swapn_jump_to_valid_immediate_fails.json                   OK
+ test_swapn_pc_advances_by_2.json                                OK
+ test_swapn_preserves_other_stack_items.json                     OK
+ test_swapn_stack_underflow.json                                 OK
+ test_swapn_valid_immediates.json                                OK
+ test_swapn_with_dup1_and_push.json                              OK
+ test_vector_dupn_followed_by_jumpdest.json                      OK
+ test_vector_dupn_invalid_0x5f.json                              OK
+ test_vector_dupn_invalid_0x60.json                              OK
+ test_vector_exchange_0x12.json                                  OK
+ test_vector_exchange_0xd0.json                                  OK
+ test_vector_exchange_invalid_0x50.json                          OK
+ test_vector_swapn_invalid_0x61.json                             OK
```
OK: 42/42 Fail: 0/42 Skip: 0/42
## identity_precompile
```diff
+ test_call_identity_precompile.json                              OK
+ test_call_identity_precompile_large_params.json                 OK
+ test_identity_precompile_returndata.json                        OK
+ test_identity_return_buffer_modify.json                         OK
+ test_identity_return_overwrite.json                             OK
```
OK: 5/5 Fail: 0/5 Skip: 0/5
## opcodes
```diff
+ test_all_opcodes.json                                           OK
+ test_call_large_args_offset_size_zero.json                      OK
+ test_call_large_offset_mstore.json                              OK
+ test_call_memory_expands_on_early_revert.json                   OK
+ test_calldatacopy.json                                          OK
+ test_calldatacopy_word_copy_oog.json                            OK
+ test_calldataload.json                                          OK
+ test_calldatasize.json                                          OK
+ test_codecopy_word_copy_oog.json                                OK
+ test_constant_gas.json                                          OK
+ test_cover_revert.json                                          OK
+ test_dup.json                                                   OK
+ test_gas.json                                                   OK
+ test_max_stack.json                                             OK
+ test_push.json                                                  OK
+ test_stack_overflow.json                                        OK
+ test_stack_underflow.json                                       OK
+ test_swap.json                                                  OK
+ test_value_transfer_gas_calculation.json                        OK
```
OK: 19/19 Fail: 0/19 Skip: 0/19
## precompiles
```diff
+ test_precompile_absence.json                                    OK
+ test_precompiles.json                                           OK
```
OK: 2/2 Fail: 0/2 Skip: 0/2
...
+ static_InternalCallStoreClearsOOG.json                          OK
...
```
OK: 259/259 Fail: 0/259 Skip: 0/259
## stStaticFlagEnabled
```diff
...
+ InternalCallStoreClearsOOG.json                                 OK
+ InternalCallStoreClearsSuccess.json                             OK
...
+ StoreClearsAndInternalCallStoreClearsOOG.json                   OK
+ StoreClearsAndInternalCallStoreClearsSuccess.json               OK
+ StoreGasOnCreate.json                                           OK
+ SuicidesAndInternalCallSuicidesBonusGasAtCall.json              OK
+ SuicidesAndInternalCallSuicidesBonusGasAtCallFailed.json        OK
+ SuicidesAndInternalCallSuicidesOOG.json                         OK
+ SuicidesAndInternalCallSuicidesSuccess.json                     OK
...
---TOTAL---
OK: 2636/2636 Fail: 0/2636 Skip: 0/2636
