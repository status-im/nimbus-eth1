...
const skipFiles = [
  ...
  "witness_codes_extcodesize.json",
  "witness_codes_extcodesize_cold_gas_boundary.json",
  ...
  "extcodehash_dynamic_argument.json",
  "extcodehash_in_init_code.json",
  "extcodehash_max_code_size.json",
  "extcodehash_via_call.json",
