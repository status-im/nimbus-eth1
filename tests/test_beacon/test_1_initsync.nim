...
let testCases = [
  ...
  TestCase(
    ...
    head: block50,
    newState: @[subchain(10, 5), subchain(50, 50)],
    reorg: true,
  ),
  ...
  TestCase(
    ...
    oldState: @[subchain(10, 5), subchain(20, 15)],
    head: block50,
    newState: @[subchain(10, 5), subchain(20, 15), subchain(50, 50)],
    reorg: true,
  ),
  ...
  TestCase(
    ...
    oldState: @[subchain(65, 60), subchain(75, 70)],
    head: block50,
    newState: @[subchain(50, 50)],
    reorg: true,
  ),
  ...
  TestCase(
    ...
    oldState: @[subchain(10, 5), subchain(65, 60)],
    head: block50,
    newState: @[subchain(10, 5), subchain(50, 50)],
    reorg: true,
  ),
  ...
  TestCase(
    name:
      "Multiple leftover subchains are present, some fully older and some fully newer",
    oldState: @[subchain(10, 5), subchain(20, 15), subchain(65, 60), subchain(75, 70)],
    head: block50,
    newState: @[subchain(10, 5), subchain(20, 15), subchain(50, 50)],
    reorg: true,
  ),
  ...
  TestCase(
    name:
      "The old subchain to be truncated and a new chain be created for the dangling head",
    blocks: @[block49B],
    oldState: @[subchain(100, 5)],
    head: block50,
    newState: @[subchain(49, 5), subchain(50, 50)],
    reorg: true,
  ),
]
