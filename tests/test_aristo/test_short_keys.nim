...
let samples = [
  ...
  @[
    (
      "80".x, "da808094c94f5374fce5edbc8e2a8697c15331677e6ebf0b822710".x,
      "27f166f1d7c789251299535cb176ba34116e44894476a7886fe5d73d9be5c973".k,
      VOID_HASH_KEY,
    ),
    (
      "01".x, "da028094c94f5374fce5edbc8e2a8697c15331677e6ebf0b822710".x,
      "81eac5f476f48feb289af40ee764015f6b49036760438ea45df90d5342b6ae61".k,
      VOID_HASH_KEY,
    ),
    (
      "02".x, "da018094c94f5374fce5edbc8e2a8697c15331677e6ebf0b822710".x,
      "463769ae507fcc6d6231c8888425191c5622f330fdd4b78a7b24c4521137b573".k,
      VOID_HASH_KEY,
    ),
    (
      "03".x, "da028094c94f5374fce5edbc8e2a8697c15331677e6ebf0b822710".x,
  ...
  test "Add and delete entries":
    ...
    for n, sample in samples:
      ...
      for iny, (k, v, r, s) in sample.reversed:
        ...
        # Check state against expected value
        let w = sig.merkleSignCommit().value
        gossip.say "*** testShortkeys, pre-del (5)",
          "n=",
          n,
          " inx=",
          inx,
        ...
        gossip.say "*** testShortkeys, post-del (6)",
          "n=",
          n,
          " inx=",
          inx,
