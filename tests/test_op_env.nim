  ...
  suite "Environmental Information Opcodes 2":
    ...
    assembler:
      ...
      code:
        ...
        Stop
      memory:
        "0x08090a0b00000000000000000000000000000000000000000000000000000000"
    ...
    assembler:
      title:
        "EIP-4399 PrevRandao: EMPTY_UNCLE_HASH"
      setup:
    ...
    assembler:
      title:
        "EIP-4844: BlobHash 128 Bit high"
      code:
    ...
    assembler:
      title:
        "EIP-4844: BlobHash 256 Bit high"
      code:
