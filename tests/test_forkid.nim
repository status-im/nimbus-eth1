...
template runForkIdTest(network: untyped, name: string) =
  test name:
    ...
    for x in `network IDs`:
      ...
      # Trivial check but this already revealed that the calculation was off
...
#     (config: MainNet, number: 1681338455'u64, time: 1681338455'u64, id: (crc: 0xdce96c2d'u32, next: 0'u64), expected: true),
...
#     (config: MainNet, number: 20000000'u64, time: 1681338455'u64, id: (crc: 0xdce96c2d'u32, next: uint64.high()), expected: true),
...
#     (config: MainNet, number: 20000000'u64, time: 1668000000'u64, id: (crc: 0xdce96c2d'u32, next: 0'u64), expected: true),
...
#     (config: MainNet, number: 20000000'u64, time: 1668000000'u64, id: (crc: 0xdce96c2d'u32, next: 1710338135'u64), expected: true),

#     # Local is mainnet currently in Shanghai only (so it's aware of Cancun), remote announces
#     # also Shanghai, and it's also aware of some random fork (e.g. misconfigured Cancun). As
#     # neither forks passed at neither nodes, they may mismatch, but we still connect for now.
#     (config: MainNet, number: 20000000'u64, time: 1668000000'u64, id: (crc: 0xdce96c2d'u32, next: uint64.high()), expected: true),

#     # Local is mainnet exactly on Cancun, remote announces Shanghai + knowledge about Cancun. Remote
#     # is simply out of sync, accept.
#     (config: MainNet, number: 21000000'u64, time: 1710338135'u64, id: (crc: 0xdce96c2d'u32, next: 1710338135'u64), expected: true),

#     # Local is mainnet Cancun, remote announces Shanghai + knowledge about Cancun. Remote
#     # is simply out of sync, accept.
#     (config: MainNet, number: 21123456'u64, time: 1710338136'u64, id: (crc: 0xdce96c2d'u32, next: 1710338135'u64), expected: true),
...
#     (config: MainNet, number: 0'u64, time: 0'u64, id: (crc: 0x3edd5b10'u32, next: 1710338135'u64), expected: true),

#     # Local is mainnet Shanghai, remote announces Cancun. Local is out of sync, accept.
#     (config: MainNet, number: 21000000'u64, time: 1700000000'u64, id: (crc: 0x9f3d2254'u32, next: 0'u64), expected: true),

#     # Local is mainnet Shanghai, remote announces Cancun, but is not aware of Prague. Local
#     # out of sync. Local also knows about a future fork, but that is uncertain yet.
#     (config: MainNet, number: 21000000'u64, time: 1678000000'u64, id: (crc: 0xc376cf8b'u32, next: 0'u64), expected: true),

#     # Local is mainnet Cancun. remote announces Shanghai but is not aware of further forks.
#     # Remote needs software update.
#     (config: MainNet, number: 21000000'u64, time: 1710338135'u64, id: (crc: 0xdce96c2d'u32, next: 0'u64), expected: false),

#     # Local is mainnet Shanghai, and isn't aware of more forks. Remote announces Shanghai +
#     # 0xffffffff. Local needs software update, reject.
#     # (config: MainNet, number: 20000000'u64, time: 1681338455'u64, id: (crc: checksumUpdate(0xdce96c2d'u32, uint64.high()), next: 0'u64), expected: false),

#     # Local is mainnet Shanghai, and is aware of Cancun. Remote announces Cancun +
#     # 0xffffffff. Local needs software update, reject.
#     # (config: MainNet, number: 20000000'u64, time: 1668000000'u64, id: (crc: checksumUpdate(0x9f3d2254'u32, uint64.high()), next: 0'u64), expected: false),

#     # Local is mainnet Shanghai, remote is random Shanghai.
#     (config: MainNet, number: 20000000'u64, time: 1681338455'u64, id: (crc: 0x12345678'u32, next: 0'u64), expected: false),

#     # Local is mainnet Prague, far in the future. Remote announces Gopherium (non existing fork)
#     # at some future timestamp 8888888888, for itself, but past block for local. Local is incompatible.
#     #
#     # This case detects non-upgraded nodes with majority hash power (typical Ropsten mess).
#     (config: MainNet, number: 88888888'u64, time: 8888888888'u64, id: (crc: 0xc376cf8b'u32, next: 8888888888'u64), expected: false),

#     # Local is mainnet Shanghai. Remote is also in Shanghai, but announces Gopherium (non existing
#     # fork) at timestamp 1668000000, before Cancun. Local is incompatible.
#     (config: MainNet, number: 20999999'u64, time: 1699999999'u64, id: (crc: 0x71147644'u32, next: 1700000000'u64), expected: false),

#   ]

# test "ValidationTests compatibleForkId":
#   # Cannot test this properply in current setup as afaik we cannot set back to a specific fork
#   # Or perhaps the way compatibleForkId does not take all cases of EIP-2124 into account?

#   for tt in ValidationTests:
#     var params = networkParams(tt.config)
#     var com = CommonRef.new(newCoreDbRef DefaultDbMemory, nil, tt.config, params)
#     let fid: ForkID = (crc: tt.id.crc, nextFork: tt.id.next)
#     let got = com.compatibleForkId(fid)
#     if got != tt.expected:
#       echo "Validation failed: config=", $tt.config, " number=", $tt.number, " time=", $tt.time,
#            " fid.crc=0x", toHex(fid.crc), " fid.nextFork=", $fid.nextFork,
#            " got=", $got, " expected=", $tt.expected
#     check got == tt.expected
