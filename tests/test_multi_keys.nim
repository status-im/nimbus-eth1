...
proc multiKeysMain*() =
  suite "random keys block witness roundtrip test":
    ...
    test "Compare multikeys using equals":
      let
        keys1 = [
          "01237124bce7762869be690036144c12c256bdb06ee9073ad5ecca18a47c3254",
          "0890cc5b491732f964182ce4bde5e2468318692ed446e008f621b26f8ff56606"
        ...
        storageKeys = [
          "0abc8a163140158288775c8912aed274fb9d6a3a260e9e95e03e70ba8df30f6b",
          "0abc7a163140158288775c8912aed274fb9d6a3a260e9e95e03e70ba8df30f6b"
        ]

      let
        m1 = initMultiKeys(keys1, storageMode = false)
        m2 = initMultiKeys(keys1, storageMode = false)
        m3 = initMultiKeys(keys2, storageMode = false)

      m1.keys[0].storageKeys = initMultiKeys(storageKeys, storageMode = true)
      m2.keys[0].storageKeys = initMultiKeys(storageKeys, storageMode = true)
      m3.keys[0].storageKeys = initMultiKeys(storageKeys, storageMode = true)
    ...
    test "Compare multikeys using equals - storageMode":
      let
        keys1 = [
          "01237124bce7762869be690036144c12c256bdb06ee9073ad5ecca18a47c3254",
          "0890cc5b491732f964182ce4bde5e2468318692ed446e008f621b26f8ff56606"
      ...
      let
        m1 = initMultiKeys(keys1, storageMode = true)
        m2 = initMultiKeys(keys1, storageMode = true)
        m3 = initMultiKeys(keys2, storageMode = true)
