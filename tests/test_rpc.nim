    ...
    test "eth_getProof - Non existent account and storage slots":
      ...
      block:
        ...
        check:
          ...
          # TODO: fix this
          verifySlotProof(proofResponse.storageHash, storageProof[0]).isMissing()
          verifySlotProof(proofResponse.storageHash, storageProof[1]).isMissing()
    ...
    test "eth_getProof - Multiple blocks":
      ...
      block:
        ...
        check:
          ...
          proofResponse.storageHash == emptyStorageHash()
          storageProof.len() == 1
          verifySlotProof(blockData.stateRoot, storageProof[0]).kind == InvalidProof
      ...
      block:
        ...
        check:
          ...
          proofResponse.storageHash == w3Hash("0x2ed06ec37dad4cd8c8fc1a1172d633a8973987fa6995b14a7c0a50c0e8d1a9c3")
          storageProof.len() == 1
          verifySlotProof(blockData.stateRoot, storageProof[0]).isValid()
