...
import stew/byteutils, unittest2, eth/[common, keys], ../nimbus/transaction
...
proc tx6(i: int): Transaction =
  const digest =
    "010657f37554c781402a22917dee2f75def7ab966d7b770905398eba3c444014".toDigest
...
proc tx7(i: int): Transaction =
  const digest =
    "01624652859a6e98ffc1608e2af0147ca4e86e1ce27672d8d3f3c9d4ffd6ef7e".toDigest
...
proc eip4844Main*() =
  ...
  suite "EIP4844 sign transaction":
    let txs = @[tx0(3), tx1(3), tx2(3), tx3(3), tx4(3), tx5(3), tx6(3), tx7(3), tx8(3)]
