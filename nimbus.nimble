...
task fluffy_test, "Run fluffy tests":
  ...
  test "fluffy/tests/portal_light_client_tests", "all_portal_light_client_tests", "-d:chronicles_log_level=ERROR -d:chronosStrictException -d:nimbus_db_backend=sqlite -d:PREFER_BLST_SHA256=false -d:canonicalVerify=true"
