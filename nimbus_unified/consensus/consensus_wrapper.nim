...
from beacon_chain/beacon_node_light_client
  import shouldSyncOptimistically, initLightClient, updateLightClientFromDag
from libp2p/protocols/pubsub/gossipsub
  import TopicParams, validateParameters, init
